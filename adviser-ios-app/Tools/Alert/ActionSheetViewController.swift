...
class ActionSheetViewController: UIViewController {
    ...
    /// cell字体颜色
    var cellTitleColor = UIColor(rgb: 0x333333)
    /// cell字体大小
    ...
    fileprivate let headerViewHight: CGFloat = 0
    fileprivate var footerViewLineHight: CGFloat = 10
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        UIView.animate(withDuration: 0.25) {
            ...
            frame.origin.y = kScreenHeight-self.tableViewHight - bottomSafeHeight
...
extension ActionSheetViewController {
    func setupUIViews() {
        ...
        tableView.separatorColor = UIColor(rgb: 0xd4d7de)
...
extension ActionSheetViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForFooterInSection section: Int) -> UIView? {
        ...
        lineView.backgroundColor = UIColor(rgb: 0xF4F4F4)
